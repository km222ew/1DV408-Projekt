    ...
    public function register() {
        ...
        $body = "
				<form action='?action=$this->register' class='form-signin' method='post'>
						...
						<input type='text' class='form-control input-lg marginb' placeholder='Username' id=$this->regUsername name=$this->regUsername value='$printUsername' required autofocus>
